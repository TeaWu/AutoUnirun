...
import robot.entity.ResponseType.ClubInfo;
import robot.entity.ResponseType.SignInTf;
import robot.entity.ResponseType.SportsClassStudentLearnClockingV0;
...
public class UniRunMain {
    ...
    public static void main(String[] args) {
        ...
        /*
          获取用户信息
         */
        UserInfo userInfo = request.login("17602301023", "Whb20011023").getResponse();
